...
extern real rho_F_avg, rho_P_avg, rho_s_avg, rho_m_avg, rho_g_avg, rho_dipole_avg, rho_forest_avg;
...
extern real **Chi[NPHMAX];	// interaction strength between slip systems
...
real **rho_F = 0;
real **rho_P = 0;
real rho_F_avg = 0.0, rho_P_avg = 0.0, rho_s_avg = 0.0, rho_m_avg = 0.0, rho_g_avg = 0.0, rho_dipole_avg = 0.0, rho_forest_avg = 0.0;;
...
real **Chi[NPHMAX]={0};	// interaction strength between slip systems
